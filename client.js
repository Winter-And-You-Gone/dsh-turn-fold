	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector('style[data-plugin-css="' + CSS_ID + '"]') === null) {
			...
			tag.textContent = [
				...
				".ccg-think-title-live{color:transparent;-webkit-text-fill-color:transparent;background:linear-gradient(90deg,var(--dsw-alias-label-secondary,#9ca3af) 0%,var(--dsw-alias-label-secondary,#9ca3af) 35%,#ffffff 50%,var(--dsw-alias-label-secondary,#9ca3af) 65%,var(--dsw-alias-label-secondary,#9ca3af) 100%);background:linear-gradient(90deg,var(--dsw-alias-label-secondary,#9ca3af) 0%,var(--dsw-alias-label-secondary,#9ca3af) 35%,color-mix(in srgb,#ffffff 70%,var(--dsw-static-deepseek-200,#7dd3fc)) 50%,var(--dsw-alias-label-secondary,#9ca3af) 65%,var(--dsw-alias-label-secondary,#9ca3af) 100%);background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;animation:1.8s linear infinite ccg-turn-status-shimmer}",

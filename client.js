	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector('style[data-plugin-css="' + CSS_ID + '"]') === null) {
			...
			tag.textContent = [
				...
				".ccg-think-title-live{color:transparent;-webkit-text-fill-color:transparent;background:linear-gradient(90deg,var(--dsw-alias-label-caption,#6b7280) 0%,var(--dsw-alias-label-caption,#6b7280) 35%,var(--dsw-alias-label-primary,#f3f4f6) 50%,var(--dsw-alias-label-caption,#6b7280) 65%,var(--dsw-alias-label-caption,#6b7280) 100%);background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;animation:3.8s linear infinite ccg-turn-status-shimmer}",
